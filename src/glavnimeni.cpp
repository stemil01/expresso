...
GlavniMeni::GlavniMeni(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::GlavniMeni), tabla(new Tabla(this)),
      mainView(new Tabla(this)), m_rasporedData("data/arrangemets") {
  ui->setupUi(this);
...
void GlavniMeni::connectSlots() {
  connect(ui->pbQuitMainMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbQuitMainMenu_clicked);
  connect(ui->pbInstructionsMainMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbHelpMainMenu_clicked);
  connect(ui->pbDTAMainMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbDTAMainMenu_clicked);
  connect(ui->pbBackDTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbBackDTAMenu_clicked);
  connect(ui->pbBackStartMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbBackStartMenu_clicked);
  connect(ui->pbStartMainMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbStartMainMenu_clicked);
  connect(ui->pbAddTableDTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::dodajNovSto);
  connect(this, &GlavniMeni::dodatNovSto, dynamic_cast<Tabla *>(tabla),
          &Tabla::postaviSto);
  connect(ui->pbRemoveTableDTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::obrisiSto);
  connect(ui->pbClearAllDTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::obrisiSve);
  connect(ui->pbSaveDTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::sacuvajRaspored);
  connect(ui->cbChooseArrangement, &QComboBox::currentIndexChanged, this,
          &GlavniMeni::ucitajRaspored);
  connect(ui->cbDesign, &QComboBox::currentIndexChanged, this,
          &GlavniMeni::ucitajRasporedDTA);
  connect(ui->pbEditMenuMainMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbEditMenuMainMenu_clicked);
  connect(ui->pbFinishEMMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbFinishEMMenu_clicked);
  connect(ui->pbAddArrangementTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::dodajRaspored);
  connect(ui->pbRemovearrangementTAMenu, &QPushButton::clicked, this,
          &GlavniMeni::obrisiRaspored);
  connect(ui->pbAddTypeEMMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbAddCategoryEMMenu_clicked);
  connect(ui->pbRemoveTypeEMMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbRemoveCategoryEMMenu_clicked);
  connect(ui->pbAddDrinkEMMenu, &QPushButton::clicked, this,
          &GlavniMeni::on_pbAddItemEMMenu_clicked);
  connect(ui->pushButton, &QPushButton::clicked, this,
          &GlavniMeni::on_pbRemoveItemEMMenu_clicked);
  connect(ui->cbTypeEMMenu, &QComboBox::currentTextChanged, this,
          &GlavniMeni::cbTypeEMMenuChanged);
}
//------------------------------------------------------------------
void GlavniMeni::on_pbAddCategoryEMMenu_clicked() {
  ...
  if (kategorija == "") {
    ...
    messageBox.setStyleSheet(
        "QMessageBox{background-color:lightgray;font-weight:bold}"
...
void GlavniMeni::on_pbAddItemEMMenu_clicked() {
  ...
  //(*(menu -> getMeni()))[kategorija] -> printInTableWidget(ui ->
  //twMenuEMMenu); menu->addItem(kategorija,pom);
}
...
void GlavniMeni::on_pbQuitMainMenu_clicked() { qApp->quit(); }
...
void GlavniMeni::dodajNovSto() {
  ...
  if (m_currentRaspored->currentNumOfTables >=
      m_currentRaspored->getMaxTables()) {
    QMessageBox messageBox;
    messageBox.setText("Maximum number of tables is " +
                       QString::number(m_currentRaspored->getMaxTables()));
    messageBox.setWindowTitle("Info");
    messageBox.setStyleSheet(
        "QMessageBox{background-color:lightgray;font-weight:bold}"
        "QMessageBox QLabel {color:red;min-width:200px;min-height:100px}");
...
void GlavniMeni::ucitajRaspored() {
  ...
  if (m_currentRaspored == nullptr) {
    // TODO: obrada greske
    // std::cerr << "no raspored with name '" << naziv.toStdString() << "'" <<
    // std::endl;
    return;
  }
...
void GlavniMeni::dodajRaspored() {
  ...
  saveInput.setStyleSheet(
      "QDialog{background-color:lightgray;font-weight:bold}");
