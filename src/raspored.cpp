...
Raspored::Raspored(const QString &rasporedName) : m_naziv(rasporedName) {
  m_idstola = 1;
}

Raspored::~Raspored() { qDeleteAll(m_raspored); }

QList<Sto *> Raspored::getItems() { return m_raspored; }
...
void Raspored::setMaxTables(qint32 num) { m_max_tables = num; }

qint32 Raspored::getMaxTables() { return m_max_tables; }
