...
TableOptions::TableOptions(QWidget *parent, Sto *sto)
    : QDialog(parent), ui(new Ui::TableOptions), m_sto(sto) {
  ui->setupUi(this);
...
TableOptions::~TableOptions() { delete ui; }
...
void TableOptions::connectSlots() {
  ...
  connect(ui->hsbWidth, &QSlider::valueChanged, this,
          &TableOptions::onHSliderWidthChanged);
  connect(ui->hsbHeight, &QSlider::valueChanged, this,
          &TableOptions::onHSliderHeightChanged);
  connect(ui->pbDefault, &QPushButton::clicked, this,
          &TableOptions::onDefaultClicked);
  connect(ui->pbApply, &QPushButton::clicked, this,
          &TableOptions::onApplyClicked);
