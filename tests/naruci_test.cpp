...
TEST_CASE("Naruci","[class]"){
    ...
    SECTION("Za prosledjeni artikl, dodati njegov naziv, kolicinu i cenu u novi red prosledjenog qtablewidget-a"){
    ...
    SECTION("U prosledjenom qtablewidget-u trazi dati naziv u prvoj koloni i u redu u kom je pronadjeni item, povecava vrijednost druge kolone za jedan"){
