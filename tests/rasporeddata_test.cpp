...
TEST_CASE("RasporedData", "[class]") {
    SECTION("Kada se ucitaju podaci, broj elementata je jedna broju fajlova u direktorijumu") {
        // Arrange
    ...
    SECTION("Kada se sacuvaju podaci, broj elemenata je jednak broju fajlova u direktorijumu") {
        // Arrange
        QString dirPath = "../src/data/arrangemets";
        RasporedData rasporedData(dirPath);
